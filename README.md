...
package](https://github.com/FantasyFootballAnalytics/ffanalytics), which this
repository once carried alongside it and has since retired. The scraping
logic, the source accuracy weights, the
